...
namespace DemoGamev1._1
{
    class Program
    {
        ...
        Precombat:
            ...
            ////Console.WriteLine("Villain:" + crntVillain + " hp:" + crntVillainHp + " ab:" + villainAB + " ad:" + villainBD);
            ...
            while (playerHP > 0)
            {
                ...
                {
                    Console.WriteLine("You hit " + crntVillain + " for " + playerBaseDamage + " damage.");
                ...
                {
                    Console.WriteLine(crntVillain + " attacks you for " + villainBD + " damage.");
